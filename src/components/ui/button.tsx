  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        sage: "bg-sage text-primary-foreground hover:bg-sage-dark shadow-card hover:shadow-card-hover",
        warm: "gradient-warm text-primary-foreground shadow-card hover:shadow-card-hover hover:opacity-90",
        soft: "bg-sage-light text-sage-dark hover:bg-sage-light/80",
        hero: "gradient-sage text-primary-foreground shadow-elevated hover:shadow-card-hover text-base py-6 px-8 rounded-xl",
        pill: "rounded-full bg-secondary text-secondary-foreground hover:bg-secondary/80 px-6",
        icon: "rounded-full p-2 bg-secondary text-secondary-foreground hover:bg-secondary/80",
      },
      size: {
